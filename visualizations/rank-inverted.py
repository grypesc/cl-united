...
def main():
    ...
    ax2 = ax1.twinx()
    ax2.plot([_+1 for _ in range(10)], inverted_per_task, 'o-', color="tab:blue", label="Translation error (cm)", linewidth=3, markersize=10)
    ax2.errorbar([_+1 for _ in range(10)], inverted_per_task, yerr=err2, fmt='o-', color="tab:blue")
    ax2.set_ylabel('Norm of covariance matrix', color="tab:blue", fontsize=28)
